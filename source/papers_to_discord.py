...
JOURNAL_SOURCES = {
    ...
    "Large-scale Assessments in Education": {
        "rss": "https://largescaleassessmentsineducation.springeropen.com/articles.rss",
...
REQUIRED_KEYWORDS = ["item", "assess", "test", "psychometric", "measurement"]
...
PREPRINT_SOURCES = {
    "arXiv": {
        "type": "arxiv",
        "keywords": [
            "item response", "IRT", "differential item functioning", "DIF",
            ...
            "educational assessment","psychological assessment", "latent trait","latent ability",
...
def format_grouped_items(items):
    ...
    lines = [f"**:loudspeaker: New Research — {today}**"]
